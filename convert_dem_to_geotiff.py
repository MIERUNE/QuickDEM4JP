...
class ConvertDEMtoGeoTiff:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ConvertDEMtoGeoTiff_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Convert_DEM_to_GeoTiff')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/convert_dem_to_geotiff/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Convert_DEM_to_Geotiff'),
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Convert_DEM_to_GeoTiff'),
                action)
            self.iface.removeToolBarIcon(action)


    def dialog_show(self):
        self.convert_DEM_to_geotiff_contents = ConvertDEMtoGeotiffContents(self.iface)
        self.convert_DEM_to_geotiff_contents.dlg.show()