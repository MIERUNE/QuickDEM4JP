...
class Ui_ConvertDEMtoGeoTiffDialogBase(object):
    def setupUi(self, ConvertDEMtoGeoTiffDialogBase):
        ConvertDEMtoGeoTiffDialogBase.setObjectName("ConvertDEMtoGeoTiffDialogBase")
        ConvertDEMtoGeoTiffDialogBase.resize(400, 312)
        self.button_box = QtWidgets.QDialogButtonBox(ConvertDEMtoGeoTiffDialogBase)
        ...
        self.mQgsProjectionSelectionWidget = QgsProjectionSelectionWidget(ConvertDEMtoGeoTiffDialogBase)
        self.mQgsProjectionSelectionWidget.setGeometry(QtCore.QRect(10, 270, 191, 22))
        font = QtGui.QFont()
        font.setPointSize(10)
